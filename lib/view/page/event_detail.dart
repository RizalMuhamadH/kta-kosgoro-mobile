...
class EventDetail extends GetView<EventController> {
  @override
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                    image: CachedNetworkImageProvider(
                        "$STORAGE_EVENT/${controller.data.value.id}/${controller.data.value.thumbnail}"),
                    fit: BoxFit.cover),
              ),
            ),
            Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                        "${controller.data.value.startDate} - ${controller.data.value.endDate}",
